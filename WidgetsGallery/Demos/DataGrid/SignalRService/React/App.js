      ...
      <div>
        {this.state.connectionStarted &&
          ...
          >
            ...
            <Column dataField={'price'} dataType={'number'} format={'#0.####'} cellComponent={PriceCell} />
            <Column dataField={'change'} dataType={'number'} width={140} format={'#0.####'} cellComponent={ChangeCell} />
